/** Response chuẩn từ HTTP API SAP Automation (RMIV.WF.CLIENT). */
export interface SapAutoApiResponse {
	Success?: boolean;
	Message?: string;
	Result?: unknown;
}
...
/** URL đích cho POST log: thêm scheme nếu thiếu; chỉ http loopback → 127.0.0.1. */
